...
const PostReviewMain = ({ data }) => {
  ...
  return (
    <div className="flex justify-between gap-5 flex-col lg:flex-row space-y-8 lg:space-y-0">
      ...
      <div className="flex flex-col items-center justify-center bg-neutralWhite rounded-[10px] p-6 lg:p-8 space-y-4 lg:space-y-6 xl:py-14 xl:space-y-8">
        {/* User profile image */}
        <img
        ...
        {/* User job title */}
        <p className="text-tertiary">{jobTitle ? jobTitle : 'HR manager'}</p>
        {/* Social media icons */}
        ...
        {/* Edit button */}
        <button className="rounded-full bg-secondary py-3 px-11 font-semibold text-[20px] text-neutralWhite tracking-wider">
          Edit
        </button>
        {/* User contact info */}
        <div className="flex justify-between w-full pt-7">
          <span className="text-primary font-semibold">Email</span>
          <span className="text-primary font-semibold">Availability</span>
        </div>
        <div className="flex items-center justify-between w-full gap-0 lg:gap-24">
          <span className="text-primaryText text-[14px]">
            {email ? email : 'Ali USAM @gmail.com'}
          </span>
          <span className="text-primaryText text-[14px]">10 hrs per day</span>
        </div>
      </div>
      {/* Card 2: Job Information */}
      <div className="bg-neutralWhite flex flex-col items-center justify-center rounded-[10px] py-6 px-4 xl:px-14 2xl:p-20 space-y-8 xl:justify-evenly xl:w-2/3">
        <div className="md:self-start space-y-3">
          {/* Job description header */}
          <h1 className="font-semibold text-primary text-[25px] lg:text-[28px] xl:text-[32px]">
            Job description
          </h1>
        ...
        <div className="flex lg:flex-row flex-col justify-between w-full lg:gap-8">
          <div className="space-y-3 mb-4">
            ...
            <h1 className="text-[18px] xl:text-[22px] font-semibold text-primary">
              Job required skills
            </h1>
            ...
            <div className="flex flex-col space-y-3">
              {JobRequiredSkills.map(({ level, skill }) => (
                <div key={skill}>
                  <p className="text-[14px] xl:text-[18px] text-secondaryText font-bold">
                    {skill}
                  </p>
                  <p className="text-[14px] xl:text-[18px] text-primaryText">
                    {level}
                  </p>
                </div>
              ))}
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col space-y-3">
                <p className="text-primaryText text-[14px] xl:text-[18px]">
                  3 workers
                </p>
                <p className="text-primaryText text-[14px] xl:text-[18px]">
