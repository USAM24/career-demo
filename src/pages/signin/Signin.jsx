  ...
  return (
    ...
    <div className="hidden lg:flex h-full w-1/2 items-center p-2 justify-center bg-primary-600 ">
      <div className="relative m-5 p-4 ">
        ...
        <img className="absolute bottom-6 right-0 z-10 h-20 object-contain" src={group} alt="groupOFvectors" /> */}
      </div>
    </div>
      ...
      <div className=" bg-primary-600  w-full">
        ...
        {/* <div className="mt-6 text-center">
          ...
          <div className="mt-4 flex justify-center space-x-4">
            <button className="bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Login with Google</button>
            <button className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Login with Facebook</button>
          </div>
        </div> */}
